...
grupos, se denota que la especie indicadora para el grupo dos obtenida
con IndVal carece de un extremo inferior (igual a 0) y su extremo
superior es 0.994; para el grupo uno no se obtuvieron especies
indicadoras con IndVal, pero con los intervalos de confianza, obtenidos
con \texttt{strassoc}, se puede concluir que la especie indicadora para
este grupo pueden ser \emph{Eugenia galalonensis} y \emph{Eugenia
