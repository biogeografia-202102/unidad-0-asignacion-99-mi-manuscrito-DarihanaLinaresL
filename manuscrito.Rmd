...
|       Nomb re original      	| Equivalencias 	|
|:---------------------------:	|:-------------:	|
...
![Diagrama de especies, sitios y variables ambientales sin colinealidad RDA.\label{fig:varesc2 tripo RDA}](rda_triplot_var.png){width=90%}
